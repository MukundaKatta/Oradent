  ...
  return (
    <div className="glass-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-stone-900 dark:text-stone-100">{t('dashboard.aiInsights', 'Insights de IA')}</h3>
      </div>
      ...
      {!insights || insights.length === 0 ? (
        <div className="py-8 text-center">
          ...
          <p className="text-sm text-stone-500 dark:text-stone-400">
            {t('dashboard.aiInsightsEmpty', 'Os insights de IA aparecerão aqui conforme os dados forem analisados.')}
          </p>
          <p className="text-xs text-stone-400 dark:text-stone-500 mt-1">
            {t('dashboard.aiInsightsHint', 'Agende consultas e registre tratamentos para começar.')}
          </p>
        </div>
      ) : (
        <div className="space-y-3">
